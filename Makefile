...
index-en:
	...
	$(SOY_COMPILER) --outputPathFormat appengine/index/generated/en/soy.js --srcs blockly-source/appengine/index/template.soy
	python build-app.py index en

puzzle-en: common-en
	$(SOY_COMPILER) --outputPathFormat appengine/puzzle/generated/en/soy.js --srcs blockly-source/appengine/puzzle/template.soy
	python build-app.py puzzle en

maze-en: common-en
	$(SOY_COMPILER) --outputPathFormat appengine/maze/generated/en/soy.js --srcs blockly-source/appengine/maze/template.soy
